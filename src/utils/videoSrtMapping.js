...
export const VIDEO_SRT_MAPPINGS = [
  ...
  },
  {
    ...
    youtubeIds: ['SbdOIdg2McI'],
    primaryUrl: 'https://www.youtube.com/watch?v=SbdOIdg2McI',
    alternateUrls: [],
    description: "BABYMONSTER (베이비몬스터) - Supa Dupa Luv synchronized SRT subtitle lyrics"
  },
  {
    id: 'babymonster_wild',
    title: "WILD",
    ...
    youtubeIds: ['PdB0EBaWKEk', '0iCHdt-px1o'],
    primaryUrl: 'https://www.youtube.com/watch?v=PdB0EBaWKEk',
    alternateUrls: ['https://www.youtube.com/watch?v=0iCHdt-px1o'],
    description: "BABYMONSTER (베이비몬스터) - WILD synchronized SRT subtitle lyrics"
  },
